...
$token = "vk1.a.HOsdYAhl_SSg5FlM-q7wmqPpydECUZzWHO9A1pQzdNffwxmUQyqFS5M74Z0Pamlw4HIlUkc69lrw4TaH7VXGCvs9ZZlGslSx0BgsweQggm-eaNpyoCkrWHSahUH2HS-QybMtX57lQ26uUiAH9hqKs6eZAnTS9NXHT-lvc4bdzHePtnMpoZpPL_YugO3lwpKZjb1QWWAXU5DHF2cNqz8v-A"; // access_token - Как получить токен описано в документации ВК
$group_id = 148573245; // ID Группы
$topic_id = 48845168; // ID Топика

$count = 10; // кол-во нужных записей. Положительное число, по умолчанию 20, максимальное значение 100
$sort = 'desc'; // asc — хронологический / desc — антихронологический
